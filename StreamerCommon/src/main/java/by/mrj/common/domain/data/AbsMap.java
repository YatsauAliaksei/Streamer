...
public abstract class AbsMap<K, V> implements Map<K, V> {
    /**
    ...
    public Set<K> keySet() {
        ...
        if (ks == null) {
            ks = new AbstractSet<K>() {
                ...
                public int size() {
                    return AbsMap.this.size();
                }

                public boolean isEmpty() {
                    return AbsMap.this.isEmpty();
                }
                ...
                public boolean contains(Object k) {
                    return AbsMap.this.containsKey(k);
                }
            };
            keySet = ks;
        }
        ...
        if (vals == null) {
            vals = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return AbsMap.this.containsValue(v);
                }
            };
            values = vals;
        }
    ...
    protected Object clone() throws CloneNotSupportedException {
        AbsMap<?, ?> result = (AbsMap<?, ?>) super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
    ...
    // some code. Since you can't set or subtract final-ness
